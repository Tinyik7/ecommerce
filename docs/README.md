...
This folder collects everything needed for the semester rubric: idea brief, UX artefacts, API/database notes, and testing evidence.

## Files

| File | Purpose |
| --- | --- |
| `project_overview.md` | Idea, target audience, problem statement, novelty. |
| `ui_ux.md` | Prototype description, user flows, navigation map, UX scenarios. |
